package com.mobai.slithermenu.coordinatormenu;
...
public class CoordinatorMenu extends FrameLayout{
    ...
    private static final String DEFAULT_SHADOW_OPACTITY = "00";
    private String mShadowOpacity = DEFAULT_SHADOW_OPACTITY;
    ...
    public CoordinatorMenu(Context context,AttributeSet arrts,int defStyleAttr) {
        super(context,arrts,defStyleAttr);
        //屏幕密度
    ...
    private class CoordinatorCallback extends ViewDragHelper.Callback {
        ...
        public void onViewCaptured(View capturedChild, int activePointerId) {
            if (capturedChild == mMenuView) {
                mViewDragHelper.captureChildView(mMenuView,activePointerId);
            }
        }
